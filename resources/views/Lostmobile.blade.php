    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Report Lost Mobile</h1>
          <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
              <!-- Card Header - Dropdown -->
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Mobile Information</h6>
              ...
              <div class="card-body">
                <!-- FORM FOR REPORTING-->
                <div class="container">
                  <form action="submitlostmobile" method="POST">
                    @csrf
                    ...
                    <input type="text" id="imei" name="imei" autocomplete="off" placeholder="" maxlength="13">
                
                    <label for="lost">Place of lost</label>
                    <input Type= "text" id="lost" name="palceoflost" placeholder="" ></input>
                    ...
                    <p>To block your mobile now CLick here! </p>
                    <a href="Mobileblocking.html" class="btn btn-secondary btn-icon-split">
                      <span class="icon text-white-50">
                        <i class="fas fa-arrow-right"></i>
                      </span>
                      <span class="text">PTA Mobile Block</span>
                    </a>
