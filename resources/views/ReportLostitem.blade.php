    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Found Any Lost Item? Report Here</h1>
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="/action_page.php">
                    <label for="Doctype">Item Found</label>
                    <select name="Doctype" id="Doctype" aria-placeholder="Select">
                    ...
                    <label for="mcompany" >Mobile compay</label>
                    <input type="text" id="mcompany" name="mcompany" placeholder="">
                    ...
                    <input type="text" id="Docinstitution" name="Docinstitution"  placeholder="">

                    <label for="cnic">C.N.I.C </label>
                    <input type="number" id="cnic" name="cnic" min="1" max="13">

                    <label for="Vehicletype">Vehicle type</label>
                    <input type="text" id="Vehicletype" name="Vehicletype"  placeholder="">

                    <label for="Regnumber">Registration Number</label>
                    <input type="text" id="Regnumber" name="Regnumber"  placeholder="">

                    <label for="Docaddress">Address On Documents</label>
                    <input type="text" id="Docaddress" name="Doaddress"  placeholder="">
                
                    <label for="found">Place of found</label>
                    <input Type= "text" id="found" name="subject" placeholder="" ></input>


                    <label for="Info">Additional Information</label>
                    <textarea id="Info" name="info" placeholder=" Type here" style="height: 100px;"></textarea>
