    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Upload FIR</h1>
          <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
              <!-- Card Header - Dropdown -->
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Upload FIR</h6>
              ...
              <!-- Card Body -->
                ...
                <div class="container">
                  <form action="{{ route('sendemail')}}" method="POST">
                    @csrf
                    <p class="mb-4">Kindly select the Police station in which the FIR has been repoted and upload the FIR</p>
                          <div class="FIR">
                            
                                <label for="PS" >Police station</label>
                                <select id="PS" name="PS" required>
                                <option value="" disabled selected>Select </option>
                                <option value="Koral chowk">Koral chowk</option>
                                <option value="Shalimar">Shalimar</option>
                                <option value="Sihala">Sihala</option>
                                <option value="F/7">F/7</option>
                                </select> 
                            <label for="FIR">Upload FIR:</label>
                            <input type="file" id="FIR" name="FIR" >
                        
                          </div>
                  
                  <div class= "col-md-6">
                          <input  class="btn btn-info btn-icon-split" type="submit" value="Send to PTA">
