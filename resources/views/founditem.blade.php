      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         <div class="card-body">
                <!-- FORM FOR REPORTING-->
                <div class="container">
                  <form action="submitfounditem" method="POST">
                   @csrf
                
                    <label for="itemfound">Item found</label>
                    <select name="itemfound" id="itemfound" aria-placeholder="Select" required>
                    ...
                    <input type="text" id="itemcolor" name="itemcolor"  placeholder="" required>
                    ...
                    <label for="placefound">Place found</label>
                    <input Type= "text" id="placefound" name="placefound" placeholder="" required></input>

                    <label for="contactnumber">Founder Contact</label>
