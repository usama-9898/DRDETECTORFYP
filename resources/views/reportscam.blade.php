    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <!-- FORM TO REPORT SCAM / SCAMMER-->
          <h1 class="h3 mb-4 text-gray-800">Report Scam</h1>
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="container">
                    <form action="submitreportscam" method="POST"> 
                      @csrf
                      <label for="scamtype">Scam Category</label>
                      <select name="scamtype" id="scamtype" aria-placeholder="Select" required>
                          <option value="" disabled selected>Select </option>
                          <option value="ecommercescam">E-commerce Scam</option>
                          <option value="Vehiclescam">Vehicle Scam</option>
                          <option value="Propertyscam">Property Scam </option>
                          <option value="Mobilescam">Mobile Scam</option>
                          <option value="Others">Others</option>
                        </select>

                      <label for="Sname" >Scammer Name</label>
                      <input type="text" id="Sname" name="Sname" placeholder="" required>

                      <label for="Scnic">C.N.I.C (If any) </label>
                      ...
                      <label for="Scontactnumber">Contact # (If any)</label>
                      ...
                      <label for="Spage">Scamming page (Add complete URL)</label>
                      <input type="text" id="Spage" name="Spage"  placeholder="" required>
  
  
                      <label for="Info">Scam Story</label>
